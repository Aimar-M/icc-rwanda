...
## Design Guidelines
- Primary colors: #2B7CB3 (blue from ICC logo), #1A5F8B (dark blue), #F5A623 (warm accent/gold)
- Secondary: #2ECC71 (green for impact stats), #FFFFFF, #F8F9FA (light backgrounds)
- Typography: Inter for body, Playfair Display for headings
- Warm, hopeful, professional tone — not clinical or corporate
- Use real photography placeholders (African community, women empowerment, education)
- Mobile-first responsive design
- Sections should breathe — generous padding, whitespace
...
- What we do
- Mission and Vision
- Our Team (Founder/CEO, Executive Director, Head of Education)
- Message from Founder and CEO
- Message from Executive Director
- Message from Head of Education Department
- People we've impacted (stats + stories)
